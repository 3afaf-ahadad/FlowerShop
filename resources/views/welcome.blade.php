...
<div id="boutique" class="bg-[#fefaf9] py-24">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-col items-center mb-16 md:mb-24 text-center">
            ...
            <h2 class="text-3xl md:text-5xl font-serif text-gray-900 tracking-tight italic">Nos Créations Signature</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-12 gap-y-24">
            ...
            <div class="group flex flex-col">
                ...
                <div class="mt-10 text-center">
                    <span class="text-[9px] text-pink-300 uppercase tracking-[0.5em] font-bold block mb-3 italic">Artisanal</span>
...
<footer class="bg-gray-50 border-t border-gray-100 py-12">
    <div class="container mx-auto px-6 text-center">
        <p class="text-[10px] text-gray-400 tracking-[0.3em] uppercase">© 2026 FlowerAtelier — Créé avec passion</p>
    </div>
</footer>
